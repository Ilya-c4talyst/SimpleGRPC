...
const file_proto_geometry_proto_rawDesc = "" +
	...
	"\x11PerimeterResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x02R\x06result2\x89\x01\n" +
	"\x0fGeometryService\x125\n" +
	"\x04Area\x12\x15.geometry.RectRequest\x1a\x16.geometry.AreaResponse\x12?\n" +
	"\tPerimeter\x12\x15.geometry.RectRequest\x1a\x1b.geometry.PerimeterResponseB/Z-github.com/my-name/grpc-service-example/protob\x06proto3"
